...
## ⚠️ IMPORTANT: Start with Discovery First

**Before implementing ANYTHING in this guide, you MUST complete the discovery phase.**
...
**The Data:**
- Discovery phase: **2% of project time**
- Prevents: **80% of implementation issues**
- Cost to fix requirements post-launch: **100x more expensive**

### How to Start Discovery

**Option 1: Full Project Orchestration (Recommended for new projects)**
```
Use the saas-project-orchestrator skill or run: /start-project
...
- Phase 4: Roadmap
- Phase 5+: Implementation (you'll be here)
```

**Option 2: Discovery Only**
```
Use the discovery-interviewer skill or run: /discovery-only

This will conduct a 90-minute structured interview to extract:
...
Once you have your discovery document approved, **THEN** proceed with this implementation guide.

The discovery document will inform:
- ✅ What schema to define in Apso (Section 4: Data Model)
- ✅ What features to build (Section 3: Core Workflows)
- ✅ What UI components you need (from workflows)
- ✅ What validation rules to implement (from edge cases)
- ✅ What success looks like (from acceptance criteria)

### Assuming You've Done Discovery

The rest of this guide assumes you have:
- [x] Completed discovery (90 min interview)
- [x] Have a discovery document (15-25 pages)
- [x] Know your data model (entities + relationships)
- [x] Know your core workflows (user actions)
- [x] Have acceptance criteria defined

**If you don't have these, STOP and run discovery first.**
...
### Week 0: Discovery (REQUIRED - Do this first!)

See above section. **Do NOT skip this.**

Use `/start-project` or invoke `saas-project-orchestrator` skill.
